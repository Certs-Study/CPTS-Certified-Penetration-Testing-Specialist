...
* [🔥 Hack The Box Certified Penetration Testing Specialist](README.md)

## Penetration Testing Process

* [Page 1](penetration-testing-process/page-1.md)
* [Getting Started](penetration-testing-process/getting-started.md)
* [Network Enumeration with Nmap](penetration-testing-process/network-enumeration-with-nmap.md)
* [Footprinting](penetration-testing-process/footprinting.md)

## Documents & Reports

* [🟢 Laws and Regulations](documents-and-reports/laws-and-regulations.md)
...
* [🟢 Tricks](network-scanning/tricks.md)
* [🟢 Saving the Results](network-scanning/saving-the-results.md)
* [🟢 Performance](network-scanning/performance.md)
* [🟢 Firewall and IDS/IPS Evasion](network-scanning/firewall-and-ids-ips-evasion.md)

## 💕 FOOTPRINTING&#x20;

* [🟢 RPC](footprinting/rpc.md)
* [NFS](footprinting/nfs.md)
* [🟢 DNS](footprinting/dns.md)
* [🟢 vHosts Enumeration](footprinting/vhosts-enumeration.md)
* [🟢 SMTP](footprinting/smtp.md)
* [🟢 POP3](footprinting/pop3.md)
...
* [Page 6](metasploit-framework/page-6.md)

## 🔥 ACTIVE DIRECTORY ENUMERATION & ATTACKS

* [Tools](active-directory-enumeration-and-attacks/tools.md)
* [External Reconnaissance](active-directory-enumeration-and-attacks/external-reconnaissance.md)
* [Hosts Enumeration](active-directory-enumeration-and-attacks/hosts-enumeration.md)
* [Identifying Users](active-directory-enumeration-and-attacks/identifying-users.md)
* [LLMNR/NBT-NS Poisoning - from Linux](active-directory-enumeration-and-attacks/llmnr-nbt-ns-poisoning-from-linux.md)
* [Password Spraying](active-directory-enumeration-and-attacks/password-spraying.md)
* [🟢 Enumerating Security Controls](active-directory-enumeration-and-attacks/enumerating-security-controls.md)
* [🟢 Living Off the Land](active-directory-enumeration-and-attacks/living-off-the-land.md)

## Web Proxies

* [Burp Shortcuts](web-proxies/burp-shortcuts.md)
